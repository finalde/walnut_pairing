...
# Note: IApplication and Application are defined in batch/application.py or webapi/application.py
...
# Note: IApplication registration is done in batch/ or webapi/ specific code
