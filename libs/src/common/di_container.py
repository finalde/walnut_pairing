...
if TYPE_CHECKING:
    # Application interface is defined in batch/application.py or webapi/application.py
    pass
...
for interface in DIRegistry._registry.keys():
    if interface not in _providers:
        ...
        # Convert common patterns: appconfig -> app_config, databaseconnection -> db_connection, walnutal -> walnut_al
